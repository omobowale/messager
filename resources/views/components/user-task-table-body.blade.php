    ...
    <script>
        $(function(){
            $(".fa-pen").click(function(){
                ...
                var category = $(this).parent().parent().find("td:nth-child(3)").text()
                var deadline = $(this).parent().parent().find("td:nth-child(4)").text()
                var status = $(this).parent().parent().find("td:nth-child(5)").text()
