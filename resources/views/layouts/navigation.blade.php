            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <!-- Authentication -->
                        <form method="POST"
                            action="{{ loggedInUserIsAdmin() ? route('admin-logout') : route('logout') }}">
                            @csrf

                            <x-dropdown-link :href="loggedInUserIsAdmin() ? route('admin-logout') : route('logout')"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Authentication -->
                <form method="POST" action="{{ loggedInUserIsAdmin() ? route('admin-logout') : route('logout') }}">
                    @csrf
                    <x-responsive-nav-link :href="loggedInUserIsAdmin() ? route('admin-logout') : route('logout')"
                        onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
